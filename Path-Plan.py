...
def get_dist_btw_pos(pos0,pos1):
    """
    Get distance between two mouse position:
    """
    x = abs(pos0[0] - pos1[0])
    y = abs(pos0[1] - pos1[1])
...
def get_angle_btw_line(pos0,pos1, posref):
    '''
    Get Angle between two lines with respect to posref
...
backg = Background('image.png', [0,0], 1.0)
screen.blit(backg.image, backg.rect)
